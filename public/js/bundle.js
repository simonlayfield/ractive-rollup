...
var appTemplate = "\n\n\t<p><uiSlider message=\"{{message}}\" /></p>\n\t<p><uiButton label=\"{{label}}\" /></p>\n\t<p>&uarr; This <em>does</em> totally work but I know it's wrong.</p>\n\n";

var apptemplate = { appTemplate: appTemplate };

var sliderComponent = "<div><p>{{message}}</p></div>";
var slider = { sliderComponent: sliderComponent };

var buttonComponent = "\n\n<button on-click=\"changeMessage()\">{{label}}</button>\n\n";

var button = { buttonComponent: buttonComponent };
